...
| OS | 다운로드 | 비고 |
|---|---|---|
| macOS (Apple Silicon) | [Noma-0.1.0-alpha-arm64.dmg](https://github.com/noma-openproject/openclaw-kr/releases/download/v0.1.0-alpha/Noma-0.1.0-alpha-arm64.dmg) | M1/M2/M3/M4 |
| macOS (Intel) | [Noma-0.1.0-alpha.dmg](https://github.com/noma-openproject/openclaw-kr/releases/download/v0.1.0-alpha/Noma-0.1.0-alpha.dmg) | Intel Mac |
| Windows | [Noma.Setup.0.1.0-alpha.exe](https://github.com/noma-openproject/openclaw-kr/releases/download/v0.1.0-alpha/Noma.Setup.0.1.0-alpha.exe) | Windows 10/11 |

> 사전 준비: Node.js 22.16+ 및 OpenClaw 설치 필요. 상세는 [Release Notes](https://github.com/noma-openproject/openclaw-kr/releases/tag/v0.1.0-alpha) 참고.
