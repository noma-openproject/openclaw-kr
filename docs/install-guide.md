...
- **Node.js 22.16 이상** (24 권장) — [nodejs.org](https://nodejs.org)에서 다운로드
...
Noma는 OpenClaw 위에서 동작합니다. 터미널에서 한 번만 실행하면 됩니다:
...
> Day 2 업데이트: Noma가 gateway를 자동으로 시작하므로, 위 설정만 하면 됩니다.
...
1. OpenClaw가 설치되어 있는지 확인: `npx openclaw --version`
2. 포트 충돌 확인: `lsof -i :18789`
3. 수동으로 시작: `npx openclaw gateway --port 18789`
